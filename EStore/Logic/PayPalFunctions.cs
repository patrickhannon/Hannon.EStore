...
public class NVPAPICaller
{
    ...
    public string APIUsername = "patrick_hannon-facilitator_api1.hotmail.com";
    private string APIPassword = "2UHARN7BHPE2SHPB";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A.zCciQagj4ixaixbvQEoQd8C8wc";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (EStore.Logic.ShoppingCartActions myCartOrders = new EStore.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            EStore.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
